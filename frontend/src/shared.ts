...
// ============================================================
// Shared state, URL helpers, panel management
// DOM refs are imported from dom-refs.ts to avoid circular deps
// ============================================================

import { GridApi } from "ag-grid-community";
import { Chart } from "chart.js";
import * as domRefs from "./dom-refs";
...
export interface StatsThreshold {
  ...
  /** "range" (observed max/min range) | "cutoff" (percentage-unit columns) — design §16.2 */
  method: "range" | "cutoff";
}
...
// ------------------------------------------------------------------
// DOM refs — re-exported from dom-refs.ts
// ------------------------------------------------------------------
export const {
  dateFromInput,
  dateToInput,
